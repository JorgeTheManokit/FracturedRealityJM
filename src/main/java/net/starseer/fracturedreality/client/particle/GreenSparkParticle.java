...
public class GreenSparkParticle extends TextureSheetParticle {
	public static GreenSparkParticleProvider provider(SpriteSet spriteSet) {
		return new GreenSparkParticleProvider(spriteSet);
	}
	...
	public static class GreenSparkParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new GreenSparkParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
	...
	protected GreenSparkParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
