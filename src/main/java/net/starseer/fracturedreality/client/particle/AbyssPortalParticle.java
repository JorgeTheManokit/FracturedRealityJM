...
@OnlyIn(Dist.CLIENT)
public class AbyssPortalParticle extends TextureSheetParticle {
	public static AbyssPortalParticleProvider provider(SpriteSet spriteSet) {
		return new AbyssPortalParticleProvider(spriteSet);
	}

	public static class AbyssPortalParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public AbyssPortalParticleProvider(SpriteSet spriteSet) {
			this.spriteSet = spriteSet;
		}

		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new AbyssPortalParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}

	private final SpriteSet spriteSet;

	protected AbyssPortalParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
