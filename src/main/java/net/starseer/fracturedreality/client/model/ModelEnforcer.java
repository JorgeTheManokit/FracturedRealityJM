...
public class ModelEnforcer<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("fractured_reality", "model_enforcer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RArmL = RArmU.addOrReplaceChild("RArmL",
				CubeListBuilder.create().texOffs(0, 31).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 52).addBox(-1.0F, 5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 43)
						.addBox(-1.5F, 3.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 55).addBox(-1.5F, 10.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(-1, 43)
						.addBox(-0.5F, 15.025F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(10, 50).addBox(-0.5F, 5.0F, -1.025F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 48)
						.addBox(-1.5F, 5.0F, -0.5F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(9, 43).addBox(-1.5F, 2.0F, -0.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(17, 40).addBox(-5.0F, -0.5F, 1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 39).addBox(-4.0F, -0.5F, -1.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(16, 39)
						.addBox(-3.0F, -0.5F, -2.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(15, 38).addBox(-2.0F, -0.5F, -3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 27)
						.addBox(-3.0F, -0.5F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 27).addBox(-1.0F, -0.5F, 2.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 27)
						.addBox(-1.0F, -0.5F, 1.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 27).addBox(-2.0F, -0.5F, 3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 22)
		...
		PartDefinition MidEye = Eyes.addOrReplaceChild("MidEye", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 1.375F));
		PartDefinition cube_r2 = MidEye.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(20, 31).addBox(1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5F, 2.1213F, 0.0F, 0.7854F, 0.0F));
		PartDefinition RightEye = Eyes.addOrReplaceChild("RightEye", CubeListBuilder.create(), PartPose.offset(-1.125F, 0.0F, 0.25F));
		PartDefinition cube_r3 = RightEye.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(20, 31).addBox(1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5F, 2.1213F, 0.0F, 0.7854F, 0.0F));
		PartDefinition LeftEye = Eyes.addOrReplaceChild("LeftEye", CubeListBuilder.create(), PartPose.offset(1.125F, 0.0F, 0.25F));
		PartDefinition cube_r4 = LeftEye.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(20, 31).addBox(1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5F, 2.1213F, 0.0F, 0.7854F, 0.0F));
