...
public class ModelStarseer<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("fractured_reality", "model_starseer"), "main");
	...
	public ModelStarseer(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = Spine.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(26, 18).addBox(0.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
		PartDefinition cube_r4 = Spine.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(26, 16).addBox(0.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition ArmSpine = Spine6.addOrReplaceChild("ArmSpine", CubeListBuilder.create().texOffs(40, 30).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 25)
				.addBox(11.0F, -6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 29).addBox(-13.0F, -6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 0.0F));
		...
		PartDefinition cube_r16 = ArmSpine.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(0, 16).addBox(0.0F, -0.5F, -0.5F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
		PartDefinition RLArm = ArmSpine.addOrReplaceChild("RLArm", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-12.0F, -4.0F, 0.0F));
		...
		PartDefinition LLArm = ArmSpine.addOrReplaceChild("LLArm", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(12.0F, -4.0F, 0.0F));
		PartDefinition LLArm2 = LLArm.addOrReplaceChild("LLArm2", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition LLArm3 = LLArm2.addOrReplaceChild("LLArm3", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition LLArm4 = LLArm3.addOrReplaceChild("LLArm4", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition ArmSpine2 = ArmSpine.addOrReplaceChild("ArmSpine2", CubeListBuilder.create().texOffs(48, 33).addBox(14.0F, -6.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 42)
				.addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 48).addBox(-16.0F, -6.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 0.0F));
		...
		PartDefinition RUArm = ArmSpine2.addOrReplaceChild("RUArm", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-15.0F, -4.5F, 0.0F));
		...
		PartDefinition LUArm = ArmSpine2.addOrReplaceChild("LUArm", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(15.0F, -4.5F, 0.0F));
		PartDefinition LUArm2 = LUArm.addOrReplaceChild("LUArm2", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition LUArm3 = LUArm2.addOrReplaceChild("LUArm3", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition LUArm4 = LUArm3.addOrReplaceChild("LUArm4", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
