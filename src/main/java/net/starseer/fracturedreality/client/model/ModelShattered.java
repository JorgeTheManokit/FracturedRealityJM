...
public class ModelShattered<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = Spine2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(48, 41).addBox(0.0F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Spine3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(48, 39).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		PartDefinition cube_r7 = Spine3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(48, 37).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 2.8798F));
		...
		PartDefinition cube_r8 = Spine4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(12, 48).addBox(0.0F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		...
		PartDefinition cube_r9 = Spine5.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(40, 2).addBox(0.0F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		...
		PartDefinition cube_r10 = Spine6.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(16, 20).addBox(0.0F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		PartDefinition cube_r11 = Spine6.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 20).addBox(0.0F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 2.8798F));
		PartDefinition ArmSpine = Spine6.addOrReplaceChild("ArmSpine",
				CubeListBuilder.create().texOffs(40, 30).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 29).addBox(-13.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));
		PartDefinition cube_r12 = ArmSpine.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, -0.5F, -0.5F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 2.8798F));
		...
		PartDefinition cube_r13 = ArmSpine2.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -0.5F, -0.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		PartDefinition cube_r14 = ArmSpine2.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(0, 12).addBox(0.0F, -0.5F, -0.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 2.8798F));
		...
		PartDefinition LUArm = ArmSpine2.addOrReplaceChild("LUArm", CubeListBuilder.create().texOffs(16, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(15.0F, 2.5F, 0.0F));
