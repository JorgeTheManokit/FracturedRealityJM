...
import net.starseer.fracturedreality.procedures.FollowerMinionOnEntityTickUpdateProcedure;
...
public class FollowerMinionEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public FollowerMinionEntity(EntityType<FollowerMinionEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		FollowerMinionOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
