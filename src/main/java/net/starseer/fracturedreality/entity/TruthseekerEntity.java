...
public class TruthseekerEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public TruthseekerEntity(EntityType<TruthseekerEntity> type, Level world) {
		super(type, world);
		xpReward = 150;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		TruthseekerOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
