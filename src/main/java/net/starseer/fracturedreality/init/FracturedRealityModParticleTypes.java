...
public class FracturedRealityModParticleTypes {
	...
	public static final DeferredHolder<ParticleType<?>, SimpleParticleType> BLUE_SPARK = REGISTRY.register("blue_spark", () -> new SimpleParticleType(true));
	public static final DeferredHolder<ParticleType<?>, SimpleParticleType> SKY_PORTAL = REGISTRY.register("sky_portal", () -> new SimpleParticleType(true));
}