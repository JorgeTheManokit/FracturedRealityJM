...
@JeiPlugin
public class FracturedRealityModBrewingRecipes implements IModPlugin {
	@Override
	public ResourceLocation getPluginUid() {
		return ResourceLocation.parse("fractured_reality:brewing_recipes");
	}
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		ingredientStack.add(new ItemStack(FracturedRealityModItems.VOID_BLOB.get()));
