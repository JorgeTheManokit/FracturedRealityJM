...
public class ModelStarseer<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "starseer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = Spine.addOrReplaceChild("cube_r3",
		...
		PartDefinition cube_r4 = Spine.addOrReplaceChild("cube_r4",
		...
		PartDefinition cube_r5 = Spine2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(48, 43).addBox(0.0F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r6 = Spine2.addOrReplaceChild("cube_r6",
		...
		PartDefinition cube_r7 = Spine3.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(48, 39).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r8 = Spine3.addOrReplaceChild("cube_r8",
		...
		PartDefinition cube_r9 = Spine4.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(12, 48).addBox(0.0F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r10 = Spine4.addOrReplaceChild("cube_r10",
		...
		PartDefinition cube_r11 = Spine5.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(40, 2).addBox(0.0F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r12 = Spine5.addOrReplaceChild("cube_r12",
		...
		PartDefinition cube_r13 = Spine6.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(16, 20).addBox(0.0F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r14 = Spine6.addOrReplaceChild("cube_r14",
		...
		PartDefinition ArmSpine = Spine6.addOrReplaceChild("ArmSpine",
				CubeListBuilder.create().texOffs(40, 30)
						...
						.addBox(11.0F, -6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 29)
						.addBox(-13.0F, -6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition cube_r15 = ArmSpine.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, -0.5F, -0.5F, 12.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -2.8798F));

		PartDefinition cube_r16 = ArmSpine.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(0, 16).addBox(0.0F, -0.5F, -0.5F, 12.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition RLArm = ArmSpine.addOrReplaceChild("RLArm", CubeListBuilder.create().texOffs(16, 22)
				.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-12.0F, -4.0F, 0.0F));
		...
		PartDefinition LLArm = ArmSpine.addOrReplaceChild("LLArm", CubeListBuilder.create().texOffs(16, 22).addBox(
				-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(12.0F, -4.0F, 0.0F));

		PartDefinition LLArm2 = LLArm.addOrReplaceChild("LLArm2", CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F,
				0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition LLArm3 = LLArm2.addOrReplaceChild("LLArm3", CubeListBuilder.create().texOffs(16, 22).addBox(
				-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition LLArm4 = LLArm3.addOrReplaceChild("LLArm4", CubeListBuilder.create().texOffs(16, 22).addBox(
				-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition ArmSpine2 = ArmSpine.addOrReplaceChild("ArmSpine2",
				CubeListBuilder.create().texOffs(48, 33)
						.addBox(14.0F, -6.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 42)
						.addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 48)
						.addBox(-16.0F, -6.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition cube_r17 = ArmSpine2.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -0.5F, -0.5F, 15.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r18 = ArmSpine2.addOrReplaceChild("cube_r18",
		...
		PartDefinition RUArm = ArmSpine2.addOrReplaceChild("RUArm", CubeListBuilder.create().texOffs(16, 35)
				.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-15.0F, -4.5F, 0.0F));
		...
		PartDefinition LUArm = ArmSpine2.addOrReplaceChild("LUArm", CubeListBuilder.create().texOffs(16, 35).addBox(
				-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(15.0F, -4.5F, 0.0F));
