...
public class Modelsmaller_armor_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "smaller_armor_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leggings = partdefinition.addOrReplaceChild("Leggings", CubeListBuilder.create().texOffs(16, 32)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(40, 32)
				.addBox(-1.8F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition LeftBoot = partdefinition.addOrReplaceChild("LeftBoot",
				CubeListBuilder.create().texOffs(48, 10)
						.addBox(-1.8F, 7.625F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)).texOffs(46, 50)
						.addBox(-1.8F, 10.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition RightBoot = partdefinition.addOrReplaceChild("RightBoot",
				CubeListBuilder.create().texOffs(46, 50)
						.addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)).texOffs(32, 10)
						.addBox(-2.0F, 7.625F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
