...
public class ModelPresenter<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "presenter"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RArmL = RArmU.addOrReplaceChild("RArmL", CubeListBuilder.create().texOffs(0, 31).addBox(-1.0F,
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(40, 20)
						.addBox(2.0F, -1.0F, 4.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(24, 40)
						.addBox(1.0F, -1.0F, 2.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 29)
						.addBox(-7.0F, -1.0F, -3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 24)
						.addBox(-4.0F, -1.0F, -3.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 39)
						.addBox(-2.0F, -1.0F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 27)
						.addBox(0.0F, -1.0F, 1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 22)
		...
		PartDefinition cube_r2 = Eye.addOrReplaceChild("cube_r2",
