 ...
 * @author Author
 */
public class voidGeneratorAnimation {
	public static final AnimationDefinition Generate = AnimationDefinition.Builder.withLength(4.0F).looping()
			.addAnimation("Fragments",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(4.0F, KeyframeAnimations.degreeVec(0.0F, -1440.0F, 0.0F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("Fragments",
