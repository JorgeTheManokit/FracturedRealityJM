...
public class ShatteredAnimation {
	public static final AnimationDefinition Base = AnimationDefinition.Builder.withLength(0.0F).looping()
			...
			.addAnimation("Spine3",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(12.5F, 0.0F, 2.5F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("Spine4",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(-5.0F, 0.0F, -5.0F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("Spine5",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("RLArm",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(14.342F, 10.9324F, -2.3006F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("RLArm2",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("LLArm",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(15.6164F, -8.9911F, -5.0553F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("LLArm2",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(-10.0F, 0.0F, 0.0F),
			...
			.addAnimation("HeadThingIDFK",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(5.0F, 0.0F, 17.5F),
									AnimationChannel.Interpolations.LINEAR)))
			...
			.addAnimation("RUArm",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.0738F, 20.1491F, 0.0826F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("RUArm2",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("LUArm",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(8.858F, -19.4557F, -5.3457F),
									AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("LUArm2",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(-5.0F, 0.0F, 0.0F),
