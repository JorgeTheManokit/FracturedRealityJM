	...
	public static final AnimationDefinition Grasp = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("Arm",
					new AnimationChannel(AnimationChannel.Targets.POSITION,
							...
							new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 155.0F, 0.0F),
									AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("Thumb",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(-7.1837F, -17.9072F, 58.4356F),
									AnimationChannel.Interpolations.CATMULLROM)))
			.addAnimation("Thumb2",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("Finger8",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.CATMULLROM)))
			.addAnimation("Finger9", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F,
					KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)))
			.build();
}